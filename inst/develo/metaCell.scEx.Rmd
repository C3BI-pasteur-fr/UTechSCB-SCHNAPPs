...
# metaDataScExFigs
if(!dir.exists(metacellDir)) dir.create(metacellDir)
...
cp = load("~/Rstudio/UTechSCB-SCHNAPPs/data/scEx.RData")
...
if(!dir.exists(metacellFigsDir)) dir.create(metacellFigsDir)
